                        ...
                        <div class="team-wrapper col-md-8 col-sm-7">        
                            <div class="row page-row" >
                                ...
                                <div class="details col-md-9 col-sm-8 col-xs-6">
                                    <h3 class="title">Juan Vasquez</h3>
                                    <h4>Director</h4>
                            ...
                            <div class="row page-row" >
                                ...
                                <div class="details col-md-9 col-sm-8 col-xs-6">
                                    <h3 class="title">Sub Directora</h3>
                                    <h4>Subdirectora</h4>
                            ...
                            <div class="row page-row" >
                                ...
                                <div class="details col-md-9 col-sm-8 col-xs-6">
                                    <h3 class="title">Ms Myriam García</h3>
