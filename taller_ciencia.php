                ...
                <div class="page-content">
                    <div class="row page-row">
                        <div class="jobs-wrapper col-md-8 col-sm-7">           
                            ...
                            <div class="box box-border page-row">
                                <ul class="list-unstyled">
                                    <li><strong>Nombre Del Taller:</strong> Física</li>
                                    <li><strong>Departamento:</strong> Ciencias e Historia</li>
                                    <li><strong>Sala:</strong> L1</li>
                                    <li><strong>Horario:</strong> 4:30 - 5:30 </li>
                            ...
                            <div class="box box-border page-row">
                                <ul class="list-unstyled">
                                    <li><strong>Nombre Del Taller:</strong> Ciencias de la Computación</li>
                                    <li><strong>Departamento:</strong> Ciencias e Historia</li>
                                    <li><strong>Sala:</strong> L8</li>
                                    <li><strong>Horario:</strong> 4:30 - 5:30 </li>
                                    <li><strong>Días a la Semana:</strong> Lunes - Martes</li>
                                    <li><strong>Materiales necesarios:</strong> Notebook(De tener equipo) </a></li>
                                </ul>                                
                            </div>
                        ...
                        <aside class="page-sidebar  col-md-3 col-md-offset-1 col-sm-4 col-sm-offset-1">      
                            <section class="widget has-divider">
                                ...
                                <ul class="job-list custom-list-style">
                                    ...
                                    <li><i class="fa fa-caret-right"></i><a href="taller_agronomo.php">Talleres Agrónomos</a></li>
