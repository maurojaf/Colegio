...
<!-- Mirrored from themes.3rdwavemedia.com/college-green/1.5.2/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Apr 2016 15:41:10 GMT -->
<head>
    <?php
    header('Content-Type: text/html; charset=UTF-8'); 
    ?>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/> 
    <title>Escuela República Argentina</title>
    <!-- Meta -->
    <!-- mobile settings -->
    ...
    <div class="wrapper">
        ...
        <div class="header-main container">
                <h1 class="logo col-md-4 col-sm-4">
                    <a href="home.php"><img id="logo" src="assets/images/logo.png" alt="Logo"></a>
                </h1><!--//logo-->           
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item"><a href="padres_apoderados.php">Padres y Apoderados</a></li>
                        <li class="nav-item dropdown">
                        ...
                        <li class="nav-item"><a href="matriculas.php">Matrículas</a></li>
