                ...
                <div class="page-content">
                    <div class="row page-row">
                        <article class="welcome col-md-8 col-sm-7">                         
                            <h3 class="title">Integrate para ayudar a integrar</h3>
                            <p><img class="img-responsive" src="assets/images/equipo_integracion.jpg" alt="" /></p>
