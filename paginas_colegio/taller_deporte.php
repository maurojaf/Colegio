                        ...
                        <div class="jobs-wrapper col-md-8 col-sm-7">           
                            ...
                            <div class="box box-border page-row">
                                <ul class="list-unstyled">
                                    <li><strong>Nombre Del Taller:</strong> Basquetball</li>
                                    <li><strong>Departamento:</strong> Ed. Física</li>
                                    <li><strong>Sala:</strong> Patio Norte</li>
                                    <li><strong>Horario:</strong> 4:30 - 6:00 </li>
                                    <li><strong>Días a la Semana:</strong> Lunes - Miercoles - Viernes</li>
                                    <li><strong>Materiales necesarios:</strong> Equipo Deportivo</a></li>
                                </ul>                                
                            </div>
                            ...
                            <div class="box box-border page-row">
                                <ul class="list-unstyled">
                                    <li><strong>Nombre Del Taller:</strong> Fútbol</li>
                                    <li><strong>Departamento:</strong> Ed. Física</li>
                                    <li><strong>Sala:</strong> Patio Sur</li>
                                    <li><strong>Horario:</strong> 4:30 - 6:00 </li>
                                    <li><strong>Días a la Semana:</strong> Lunes - Miercoles - Viernes</li>
                                    <li><strong>Materiales necesarios:</strong> Equipo Deportivo</a></li>
                                </ul>                                 
                            ...
                            <div class="box box-border page-row">
                                <ul class="list-unstyled">
                                    <li><strong>Nombre Del Taller:</strong> Volleyball</li>
                                    <li><strong>Departamento:</strong> Ed. Física</li>
                                    <li><strong>Sala:</strong> Cancha volleyball</li>
                                    <li><strong>Horario:</strong> 4:30 - 6:00 </li>
                                    <li><strong>Días a la Semana:</strong> Lunes - Miercoles - Viernes</li>
                                    <li><strong>Materiales necesarios:</strong> Equipo Deportivo</a></li>
                                </ul>                                
