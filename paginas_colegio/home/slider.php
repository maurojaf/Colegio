                ...
                <ul class="slides">
                    <li>
                        ...
                        <p class="flex-caption">
                            <span class="main" >Unete a nosotros </span>
                            <br />
                            <span class="secondary clearfix" >Elige calidad y excelencia academica por mas de 5 a&ntilde;os consecutivos.</span>
                        </p>
                    </li>
                    <li>
                        <img src="assets/images/slides/slide-2.jpg"  alt="" />
                        <p class="flex-caption">
                            <span class="main" >Ven a nuestras Charlas de Enseñanza</span>
                            <br />
                    ...
                    <li>
                        ...
                        <p class="flex-caption">
                            <span class="main" >Material Online para una mejor y oportuna enseñanza</span>
                            <br />
                    ...
                    <li>
                        ...
                        <p class="flex-caption">
                            <span class="main" >Becas, Junaeb y otros beneficios</span>
                            <br />
