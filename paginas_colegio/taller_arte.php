                        ...
                        <div class="jobs-wrapper col-md-8 col-sm-7">           
                            ...
                            <div class="box box-border page-row">
                                <ul class="list-unstyled">
                                    <li><strong>Nombre Del Taller:</strong> Dibujos</li>
                                    <li><strong>Departamento:</strong> Artes y Tecnología</li>
                                    <li><strong>Sala:</strong> L5</li>
                                    <li><strong>Horario:</strong> 4:30 - 5:30 </li>
                                    <li><strong>Días a la Semana:</strong> Martes - Jueves</li>
                                    <li><strong>Materiales necesarios:</strong> Bloq Dibujo y Lápices </a></li>
                                </ul>                                
                            </div>
                            ...
                            <div class="box box-border page-row">
                                <ul class="list-unstyled">
                                    <li><strong>Nombre Del Taller:</strong> Pintura al Oleo</li>
                                    <li><strong>Departamento:</strong> Artes y Tecnología</li>
                                    <li><strong>Sala:</strong> L7</li>
                                    <li><strong>Horario:</strong> 4:30 - 5:30 </li>
                            ...
                            <div class="box box-border page-row">
                                <ul class="list-unstyled">
                                    <li><strong>Nombre Del Taller:</strong> Artes Manuales</li>
                                    <li><strong>Departamento:</strong> Artes y Tecnología</li>
                                    <li><strong>Sala:</strong> L6</li>
                                    <li><strong>Horario:</strong> 4:30 - 5:30 </li>
