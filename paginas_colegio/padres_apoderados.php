                    ...
                    <div class="row page-row">
                        <div class="course-wrapper col-md-8 col-sm-7">                         
                            <article class="course-item">
                                ...
                                <div class="page-row">
                                    <p>CEPA es el organismo encargado de la correcta difusión, coordinación, organización y un largo etc... de todas las actividades que se deseen realizar dentro de un grupo curso.
                                    Con la ayuda de los organizadores y el grupo curso de apoderados se llegarán a consenso y cumpliendo el correcto protocolo se pueden lograr muchas actividades ricas en experiencia educativa y de esparcimiento.</p>
                                ...
                                <div class="tabbed-info page-row">             
                                    <ul class="nav nav-tabs">
                                      <li class="active"><a href="#tab1" data-toggle="tab">Reuniones De curso</a></li>
                                      <li><a href="#tab2" data-toggle="tab">Actividades Extraprogramáticas</a></li>
                                      <li><a href="#tab3" data-toggle="tab">Actividades Fin de Año</a></li>
                                    </ul>
                        ...
                        <aside class="page-sidebar  col-md-3 col-md-offset-1 col-sm-4 col-sm-offset-1">     
                            ...
                            <div class="login">
                              <h1>Portal Apoderados</h1>
                                  <form method="post" action="#">
                                    <p><input type="text" name="login" value="" placeholder="Rut"></p>
                                    ...
                                    <div class="login-help">
                                      <p>Olvidaste tu contraseña? <a href="index.html">Click aquí para resetearla</a>.</p>
                                    </div>
                            </section>

                            
                            <section class="widget has-divider">
                                <h3 class="title">Contactate con CEPA </h3>
                                <p>Contáctate con nosotros ante cualquier duda sobre reuniones o cualquier otro asunto relacionado con tu hijo</p>
                                <p class="tel"><i class="fa fa-phone"></i>Tel: 222 222 277</p>
                                <p class="email"><i class="fa fa-envelope"></i>Email: <a href="#">cepa@repargentina.cl</a></p>
                            </section><!--//widget-->      
                            <section class="widget has-divider">
                                <h3 class="title">Programas Relacionados</h3>
